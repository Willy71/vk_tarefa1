...
with st.container():
  ...
  with col02:
    sf.text_left("Carregar os dados das três tabelas.", 6, "lightblue")
    sf.text_left("Explorar e cruzar os dados para gerar insights sobre:", 6, "lightblue")
    sf.text_left("Distribuição de leads por canal e tráfego.", 6, "lightblue")
    sf.text_left("Taxa de conversão por canal/anúncio.", 6, "lightblue")
    sf.text_left("Perfis demográficos dos leads e compradores.", 6, "lightblue")
    sf.text_left("Vou iniciar carregando e analisando os dados das três tabelas.", 6, "lightblue")
