...
sf.text_left("001_TabelaPesquisaUTMsn.csv", 5, "blue")
...
sf.text_left("002_TabelaVendas.csv", 5, "blue")
...
sf.text_left("003_TabelaPesquisa.csv", 5, "blue")
...
sf.text_left("004_TabelaAdsLinks.csv", 5, "blue")
