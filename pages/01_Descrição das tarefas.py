...
sf.left_text("001_TabelaPesquisaUTMsn.csv", 5, "blue")
...
sf.left_text("002_TabelaVendas.csv", 5, "blue")
...
sf.left_text("003_TabelaPesquisa.csv", 5, "blue")
...
sf.left_text("004_TabelaAdsLinks.csv", 5, "blue")
